...
- The original numbered Markdown specs remain in `context/` and should be treated as source of truth for domain behavior. Read `context/00-overview.md` first, then module docs; use `context/09-api-design.md` and `context/10-database.md` as cross-cutting references.
